  ...
  signingConfigs {
    create("release") {
      val keystorePath = providers.environmentVariable("KEYSTORE_PATH")
        .orElse(providers.gradleProperty("KEYSTORE_PATH"))
        .orNull ?: "${rootDir}/release-keystore.jks"

      val keystoreFile = file(keystorePath)
      val storePass = providers.environmentVariable("KEYSTORE_PASSWORD")
      ...
      val alias = providers.environmentVariable("KEY_ALIAS")
        ...
        .orNull ?: "upload"
      val keyPass = providers.environmentVariable("KEY_PASSWORD")
